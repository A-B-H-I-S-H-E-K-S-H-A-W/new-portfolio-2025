...
export const HeroParallax = ({ products }) => {
  ...
  return (
    <section
      id="projects"
      className="min-h-screen dark:bg-black-100 bg-blue-200"
    >
      <div className="min-h-screen w-full z-20 dark:bg-black-100 bg-blue-200 dark:bg-grid-white/[0.01] bg-grid-black/[0] relative flex justify-center">
        ...
        <div className="flex flex-col w-full justify-start">
          <div className="flex flex-col justify-center items-center">
            ...
            <div
              id="projects"
              ref={ref}
              className="lg:h-[360vh] md:h-[315vh] sm:h-[310vh] h-[300vh] py-40 z-50 overflow-hidden  antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d]"
            >
              <Header />
              <motion.div
                style={{
...
export const ProductCard = ({ product, translate }) => {
  return (
    ...
    >
      ...
      <span className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white">
        {product.title}
      </span>
    </motion.div>
  );
